...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#050823] text-gray-300">
      <div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#050823] flex flex-col justify-center items-center"
        }
      >
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#5f5f69]">
            <a
              className=" flex justify-between items-center w-full text-gray-300"
              href="https://drive.google.com/file/d/1DkEDY_lzHzQ4sypaRfCoIkM99vQHyfr0/view?usp=sharing"
            >
